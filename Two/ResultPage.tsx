...
function ResultPage() {
  ...
  const handleFeedbackSubmit = async () => {
    ...
    try {
      ...
      const feedbackResponse = await fetch(`http://localhost:5000/api/submit-feedback`, {
      ...
      const assessResponse = await fetch(`http://localhost:5000/api/generate-narrative`, {
            ...
            <div className="mb-8 bg-white/5 p-6 rounded-xl">
              ...
              {scoreData.riskNarrative ? (
                ...
                <div className="text-gray-400 italic">
                  ...
                  Generating analysis... <Loader2 className="inline animate-spin" />
